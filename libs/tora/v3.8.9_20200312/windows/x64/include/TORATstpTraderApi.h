...
public:
	...
	//录入节点资金分配信息应答	
	virtual void OnRspInputNodeFundAssignment(CTORATstpInputNodeFundAssignmentField *pInputNodeFundAssignmentField, CTORATstpRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
	
	//查询节点资金分配比例应答	
	virtual void OnRspInquiryNodeFundAssignment(CTORATstpRspInquiryNodeFundAssignmentField *pRspInquiryNodeFundAssignmentField, CTORATstpRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
	...
	//外围系统仓位转移回报
	virtual void OnRtnPeripheryTransferPosition(CTORATstpRtnPeripheryTransferPositionField *pRtnPeripheryTransferPosition) {};
	
	//外围系统资金转移回报
	virtual void OnRtnPeripheryTransferFund(CTORATstpRtnPeripheryTransferFundField *pRtnPeripheryTransferFund) {};
	...
	//查询系统节点信息
	virtual void OnRspQrySystemNodeInfo(CTORATstpSystemNodeInfoField *pSystemNodeInfo, CTORATstpRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {}; 
